...
@section('content')
<body>
    <h1 class="text-center mb-4">EDIT DATA PREPARATION</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <form action="/updatedataprep/{{$data->productionid}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <select class="custom-select" name="spesies" >
                                    <option selected>{{$data->spesies}}</option>
